package app.cloud.ccwb.cn.linlibrary.expand;
...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    private static ExpandIndicatorController setupExpandToggleController(@NonNull Context context, TypedArray typedArray) {
        ...
        if (expandToggleType == EXPAND_INDICATOR_IMAGE_BUTTON) {
        ...
        } else if (expandToggleType == EXPAND_INDICATOR_TEXT_VIEW) {
    ...
    static class ImageButtonExpandController implements ExpandIndicatorController {
        ...
        ImageButtonExpandController(Drawable expandDrawable, Drawable collapseDrawable) {
