...
import app.cloud.ccwb.cn.linlibrary.loading.manager.StyleManager;
...
//            }
//        };
        myHandler = new MyHandler(LoadingDialog.this);
        // 设置返回键无效
...
//            }
    ...
    public void dispatchFinishEvent(View v) {
        if (v instanceof WrongDiaView) {
            myHandler.sendEmptyMessageDelayed(2, time);
        } else {
...
//    };
    ...
    private static class MyHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (dialog != null) {
                dialog.close();
                if (null != dialog.onFinshListener) {
                    dialog.onFinshListener.onFinish();
                }
            }
        }
    }
