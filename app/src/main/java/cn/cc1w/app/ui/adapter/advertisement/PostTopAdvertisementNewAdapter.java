 ...
 * 新闻详情中的 广告 adaater
 */
public class PostTopAdvertisementNewAdapter extends RecyclerView.Adapter<PostTopAdvertisementNewAdapter.ViewHolder> {
    ...
    public PostTopAdvertisementNewAdapter(Context context) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_ad_top_new_detail_news_recycle, parent, false));
    }
    ...
    public void onBindViewHolder(@NotNull ViewHolder holder, int position) {
        ...
        if (null != postAdEntity) {
            AppUtil.loadNewsTopAdvertisement(postAdEntity.getPic_path(), holder.imageView);
                            ...
                            if (!TextUtils.isEmpty(url)) {
                                ...
                                if (config != null && config.isAllow_jump_url()) {
                                    ...
                                    for (String s : whiteList) {
                                        LogUtil.d("TOP -- onBindViewHolder--s = " + s);
                                        if (url.startsWith(s)) {
                                            result = true;
                                            break;
                                        }
