...
public class HotTopicEntity {
    ...
    private List<ItemHotTopicEntity> data;
    ...
    public List<ItemHotTopicEntity> getData() {
        return data;
    }

    public void setData(List<ItemHotTopicEntity> data) {
        this.data = data;
    }

    public static class ItemHotTopicEntity {
