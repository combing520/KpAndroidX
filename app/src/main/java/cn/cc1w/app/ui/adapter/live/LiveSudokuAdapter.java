 ...
 * @author kpinfo
 */
public class LiveSudokuAdapter extends RecyclerView.Adapter<LiveSudokuAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_gallery_sudoku, parent, false));
    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            postImg = itemView.findViewById(R.id.img_live_sudoku);
        }
    }
}