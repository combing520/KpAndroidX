 ...
 * 专题View 【推送】
 */
public class PushSpecialView {
    private final Context context;
    private final PushNewsGroupEntity.ItemPushNewsGroupEntity entity;
    private final PushNewsGroupAdapter.SpecialHolder holder;

    public PushSpecialView(Context context, RecyclerView.ViewHolder holder, PushNewsGroupEntity.ItemPushNewsGroupEntity entity) {
        this.context = context;
        this.entity = entity;
        this.holder = (PushNewsGroupAdapter.SpecialHolder) holder;
    }
            ...
            holder.container.setOnClickListener(v -> {
                ...
                if (!TextUtils.isEmpty(newsId) && !TextUtils.isEmpty(type)) {
                    ...
                    if (Constant.TYPE_NEWS_NORMAL.equals(type)) { // 普通新闻
                        ...
                        intent.putExtra("summary", TextUtils.isEmpty(item.getSummary()) ? "" : item.getSummary());
                        context.startActivity(intent);
