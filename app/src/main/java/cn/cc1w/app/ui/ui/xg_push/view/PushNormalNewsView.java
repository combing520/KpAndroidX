 ...
 * 普通新闻的View[推送]
 */
public class PushNormalNewsView {
    private final Context context;
    private final PushNewsGroupEntity.ItemPushNewsGroupEntity entity;
    private final PushNewsGroupAdapter.NormalNewsHolder holder;

    public PushNormalNewsView(Context context, RecyclerView.ViewHolder holder, PushNewsGroupEntity.ItemPushNewsGroupEntity entity) {
        this.context = context;
        this.entity = entity;
        this.holder = (PushNewsGroupAdapter.NormalNewsHolder) holder;
    }
