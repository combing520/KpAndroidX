 ...
 * @author kpinfo
 */
public class PushAlbumGroupView {
    private final Context context;
    private final PushNewsGroupEntity.ItemPushNewsGroupEntity entity;
    private final PushNewsGroupAdapter.AlbumGroupHolder holder;

    public PushAlbumGroupView(Context context, RecyclerView.ViewHolder holder, PushNewsGroupEntity.ItemPushNewsGroupEntity entity) {
        this.context = context;
        this.entity = entity;
        this.holder = (PushNewsGroupAdapter.AlbumGroupHolder) holder;
    }
