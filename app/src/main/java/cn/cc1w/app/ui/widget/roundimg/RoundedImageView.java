package cn.cc1w.app.ui.widget.roundimg;
...
public class RoundedImageView extends ImageView {
    ...
    public void setScaleType(ScaleType scaleType) {
        ...
        if (mScaleType != scaleType) {
            ...
            if (scaleType == ScaleType.CENTER || scaleType == ScaleType.CENTER_CROP || scaleType == ScaleType.CENTER_INSIDE || scaleType == ScaleType.FIT_CENTER || scaleType == ScaleType.FIT_START || scaleType == ScaleType.FIT_END || scaleType == ScaleType.FIT_XY) {
