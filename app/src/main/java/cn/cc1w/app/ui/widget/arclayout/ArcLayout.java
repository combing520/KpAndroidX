package cn.cc1w.app.ui.widget.arclayout;
...
public class ArcLayout extends FrameLayout {
    ...
    private Path createClipPath() {
        ...
        if (settings.getPosition() == ArcLayoutSettings.POSITION_BOTTOM) {
        ...
        } else if (settings.getPosition() == ArcLayoutSettings.POSITION_TOP) {
            if (settings.isCropInside()) {
        ...
        } else if (settings.getPosition() == ArcLayoutSettings.POSITION_LEFT) {
            if (settings.isCropInside()) {
                path.moveTo(width, 0);
                path.lineTo(0, 0);
        ...
        } else if (settings.getPosition() == ArcLayoutSettings.POSITION_RIGHT) {
            if (settings.isCropInside()) {
                path.moveTo(0, 0);
                path.lineTo(width, 0);
