...
public class UserCollectionAdapter extends RecyclerView.Adapter<UserCollectionAdapter.ViewHolder> {
    ...
    private final List<CollectionEntity.ItemCollectionEntity> dataSet = new ArrayList<>();
     ...
     * @param list 数据源
     */
    public void setData(List<CollectionEntity.ItemCollectionEntity> list) {
     ...
     * @param list 数据源
     */
    public void addData(List<CollectionEntity.ItemCollectionEntity> list) {
        if (null != list && !list.isEmpty()) {
            dataSet.addAll(list);
            notifyDataSetChanged();
        }
     ...
     * @return 对应的条目
     */
    public CollectionEntity.ItemCollectionEntity getItem(int pos) {
    ...
    public void onBindViewHolder(@NotNull ViewHolder holder, int position) {
        CollectionEntity.ItemCollectionEntity item = getItem(position);
        if (null != item) {
     ...
     * @param pos 指定的位置
     */
    public void deleteCollectionItem(int pos) {
        dataSet.remove(pos);
        notifyDataSetChanged();
    }
