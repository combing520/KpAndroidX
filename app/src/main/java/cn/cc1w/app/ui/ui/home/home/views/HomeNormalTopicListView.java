...
public class HomeNormalTopicListView {
    ...
    private final HomeNewsAdapter.NormalTopicHolder holder;
    private long lastTime;

    public HomeNormalTopicListView(Context ac, int i, RecyclerView.ViewHolder h, HomeNewsEntity.ItemHomeNewsEntity entity) {
        this.context = ac;
        this.entity = entity;
        holder = (HomeNewsAdapter.NormalTopicHolder) h;
