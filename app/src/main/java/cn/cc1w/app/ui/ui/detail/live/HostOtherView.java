 ...
 * @author kpinfo
 */
public class HostOtherView {
    private final LiveHostEntity.LiveHostItemEntity entity;
    private final HostRoomMessageAdapter.HostOtherHolder holder;

    public HostOtherView(Context context, int position, RecyclerView.ViewHolder holder, LiveHostEntity.LiveHostItemEntity entity) {
//        Context context1 = context;
//        int index = position;
        this.entity = entity;
        this.holder = (HostRoomMessageAdapter.HostOtherHolder) holder;
    }
