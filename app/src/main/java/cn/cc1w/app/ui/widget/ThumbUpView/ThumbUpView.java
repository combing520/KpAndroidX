package cn.cc1w.app.ui.widget.ThumbUpView;
...
public class ThumbUpView extends View {
    ...
    private int edgeColor = Color.GRAY;
    private int fillColor = Color.rgb(229, 20, 60);
    ...
    private void init(AttributeSet attrs) {
        ...
        if (typedArray != null) {
            ...
            bgColor = typedArray.getColor(R.styleable.ThumbUpView_bkgColor, bgColor);
