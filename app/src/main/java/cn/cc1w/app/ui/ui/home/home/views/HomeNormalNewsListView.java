 ...
 * 首页普通新闻
 */
public class HomeNormalNewsListView {
    private final Context context;
    private final HomeNewsEntity.ItemHomeNewsEntity entity;
    private final HomeNewsAdapter.NormalNewsHolder holder;
    private long lastTime;

    public HomeNormalNewsListView(Context ac, int i, RecyclerView.ViewHolder h, HomeNewsEntity.ItemHomeNewsEntity entity) {
        this.context = ac;
        this.entity = entity;
        holder = (HomeNewsAdapter.NormalNewsHolder) h;
