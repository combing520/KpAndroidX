 ...
 * 活动的View[推送]
 */
public class PushUrlView {
    private final Context context;
    private final PushNewsGroupEntity.ItemPushNewsGroupEntity entity;
    private final PushNewsGroupAdapter.UrlHolder holder;

    public PushUrlView(Context context, int position, RecyclerView.ViewHolder holder, PushNewsGroupEntity.ItemPushNewsGroupEntity entity) {
        this.context = context;
//        int index = position;
        this.entity = entity;
        this.holder = (PushNewsGroupAdapter.UrlHolder) holder;
    }
