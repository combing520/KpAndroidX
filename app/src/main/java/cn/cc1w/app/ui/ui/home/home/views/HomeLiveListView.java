 ...
 * 首页普通新闻
 */
public class HomeLiveListView {
    private final Context activity;
    private final HomeNewsEntity.ItemHomeNewsEntity entity;
    private final HomeNewsAdapter.LiveHolder holder;
    private long lastTime;

    public HomeLiveListView(Context ac, int i, RecyclerView.ViewHolder h, HomeNewsEntity.ItemHomeNewsEntity entity) {
        activity = ac;
        this.entity = entity;
        holder = (HomeNewsAdapter.LiveHolder) h;
            ...
            holder.btnMore.setOnClickListener(v -> {
                ...
                if (currentTime - lastTime >= Constant.MIN_TIME_INTERVAL) {
                    ...
                    if (!TextUtils.isEmpty(id)) {
                        ...
                        intent.setClass(activity, MoreLiveActivity.class);
