 ...
 * [新闻组的View ] 推送
 */
public class PushNewsGroupView {
    private final Context context;
    private final PushNewsGroupEntity.ItemPushNewsGroupEntity entity;
    private final PushNewsGroupAdapter.NewsGroupHolder holder;

    public PushNewsGroupView(Context context, RecyclerView.ViewHolder holder, PushNewsGroupEntity.ItemPushNewsGroupEntity entity) {
        this.context = context;
        this.entity = entity;
        this.holder = (PushNewsGroupAdapter.NewsGroupHolder) holder;
    }
