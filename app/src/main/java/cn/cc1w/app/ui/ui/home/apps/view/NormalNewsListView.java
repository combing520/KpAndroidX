 ...
 * @author kpinfo
 */
public class NormalNewsListView {
    private final Context context;
    private final NewsEntity.DataBean entity;
    private final AppsDetailNewsAdapter.NormalNewsHolder holder;
    private long lastTime;

    public NormalNewsListView(Context ac, int i, RecyclerView.ViewHolder h, NewsEntity.DataBean entity) {
        this.context = ac;
//        int index = i;
        this.entity = entity;
        holder = (AppsDetailNewsAdapter.NormalNewsHolder) h;
