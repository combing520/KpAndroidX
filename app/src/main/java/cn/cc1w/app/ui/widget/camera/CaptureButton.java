...
import static cn.cc1w.app.ui.widget.camera.JCameraView.BUTTON_STATE_BOTH;
import static cn.cc1w.app.ui.widget.camera.JCameraView.BUTTON_STATE_ONLY_CAPTURE;
import static cn.cc1w.app.ui.widget.camera.JCameraView.BUTTON_STATE_ONLY_RECORDER;
...
import cn.cc1w.app.ui.widget.camera.listener.CaptureListener;
...
public class CaptureButton extends View {
    ...
    //    private final int progress_color = 0xC81F1D;            //进度条颜色
//    private final int outside_color = 0xEEDCDCDC;             //外圆背景色
//    private final int inside_color = 0xFFFFFFFF;              //内圆背景色
    private static final int progress_color = 0xFFFF0000;            //进度条颜色
    private static final int outside_color = 0xEEDCDCDC;             //外圆背景色
    private static final int inside_color = 0xFFFF0000;              //内圆背景色
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        } else if (action == MotionEvent.ACTION_UP) {//根据当前按钮的状态进行相应的处理
