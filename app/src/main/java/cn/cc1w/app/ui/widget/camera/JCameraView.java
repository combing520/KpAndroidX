...
import cn.cc1w.app.ui.widget.camera.listener.TypeListener;
import cn.cc1w.app.ui.widget.camera.state.CameraMachine;
...
import cn.cc1w.app.ui.widget.camera.view.CameraView;
/**
 * @author kpinfo
 */
...
//        });
    ...
    //生命周期onPause
    public void onPause() {
        KLog.i(TAG,"JCameraView onPause");
        stopVideo();
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        KLog.i(TAG,"JCameraView SurfaceCreated");
        new Thread() {
            @Override
            public void run() {
    ...
    public void surfaceDestroyed(SurfaceHolder holder) {
        KLog.i(TAG,"JCameraView SurfaceDestroyed");
...
//                    KLog.i("CJT", "result = " + (result - firstTouchLength));
            }
